...
import com.hbfu.community.util.MailClient;
import com.hbfu.community.util.RedisKeyUtil;
...
//        return userMapper.selectById(id);
    ...
    public Map<String,Object> register(User user) {
        ...
        user.setHeaderUrl(String.format("http://img.zdbest.top/hbfu_xh.jpg"));
        user.setCreateTime(new Date());
        userMapper.insertUser(user);//会将生成的id回填，mybatis.configuration.use-generated-keys=true
